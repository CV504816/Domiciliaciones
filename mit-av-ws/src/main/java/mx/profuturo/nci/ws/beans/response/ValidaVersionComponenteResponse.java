...
public class ValidaVersionComponenteResponse {
	private String codRet;
	private String msgRet;
	private String descRet;
	
	public ValidaVersionComponenteResponse() {
		// TODO Auto-generated constructor stub
	}

	public ValidaVersionComponenteResponse(String codRet, String msgRet, String descRet) {
		this.codRet = codRet;
		this.msgRet = msgRet;

...
public class MovBancoBean {
	...
	private GenericoCatalogoBean refSubcuentaApovol;
	...
	public GenericoCatalogoBean getRefSubcuentaApovol() {
		return refSubcuentaApovol;
	}

	public void setRefSubcuentaApovol(GenericoCatalogoBean refSubcuentaApovol) {
		this.refSubcuentaApovol = refSubcuentaApovol;
	}

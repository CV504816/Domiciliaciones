package mx.profuturo.nci.ws.service.impl.conciliacion;
...
import mx.profuturo.nci.ws.service.conciliacion.IConciliacionSoapService;
...
public class ConciliacionSoapServiceImpl implements IConciliacionSoapService {
	...
	public ConciliacionConsultarIdPagoBeanResponse consultaIdPagoApovol() {
		...
		try {
			...
			response.setIdPagoApovol(conciliacionService.getIdPagoApovol());
				return response;

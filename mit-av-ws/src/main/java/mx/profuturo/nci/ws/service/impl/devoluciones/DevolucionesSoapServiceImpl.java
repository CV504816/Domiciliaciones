package mx.profuturo.nci.ws.service.impl.devoluciones;
...
import mx.profuturo.nci.business.service.IDevolucionesService;
...
import mx.profuturo.nci.ws.beans.request.DevolucionesActualizaBeanRequest;
import mx.profuturo.nci.ws.beans.request.DevolucionesConsultaListaBeanRequest;
import mx.profuturo.nci.ws.beans.request.DevolucionesEnvioCIFBeanRequest;
import mx.profuturo.nci.ws.beans.request.DevolucionesListaEstatusBeanRequest;
import mx.profuturo.nci.ws.beans.response.DevolucionesActualizaBeanResponse;
import mx.profuturo.nci.ws.beans.response.DevolucionesConsultaListaBeanResponse;
import mx.profuturo.nci.ws.beans.response.DevolucionesEnvioCIFBeanResponse;
import mx.profuturo.nci.ws.beans.response.DevolucionesListaEstatusBeanResponse;
import mx.profuturo.nci.ws.exceptions.FaultBeanServiceInfo;
import mx.profuturo.nci.ws.exceptions.MitWebServiceException;
//import mx.profuturo.nci.ws.service.devoluciones.IDevolucionesSoapService;

@Service("devolucionesSoapService")
public class DevolucionesSoapServiceImpl  {
		...
		try {
			...
			if(request.getEstatus() != null) {
				if("0".equals(request.getEstatus())) {
					//fop se comenta la siguiente linea por eliminarce la percistencia de Alux

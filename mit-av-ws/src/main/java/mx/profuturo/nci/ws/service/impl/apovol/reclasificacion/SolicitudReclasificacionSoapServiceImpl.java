package mx.profuturo.nci.ws.service.impl.apovol.reclasificacion;
...
import mx.profuturo.nci.ws.beans.DiversificacionSolicitudReclasificacionBean;
import mx.profuturo.nci.ws.beans.GenericoCatalogoBean;
import mx.profuturo.nci.ws.beans.SolicitudReclasificacionBean;
...
import mx.profuturo.nci.ws.service.apovol.reclasificacion.ISolicitudReclasificacionApoVolSoapService;

@Service("solicitudReclasificacionSoapService")
public class SolicitudReclasificacionSoapServiceImpl implements ISolicitudReclasificacionApoVolSoapService {
	...
	public SolicitudReclasificacionConsultarBeanResponse guardarSolicitudApoVol(
		...
		try {
			...
			SolicitudReclasificacionApoVolVO solicitudVO = new SolicitudReclasificacionApoVolVO();
			...
			SolicitudReclasificacionApoVolVO solicitudReclasificacionVO = solicitudReclasificacionService.consultarSolicitud(solicitudRequest);
	...
	public SolicitudReclasificacionConsultarBeanResponse consultarSolicitudApoVol(
		...
		try {
			SolicitudReclasificacionApoVolVO solicitudReclasificacionVO = solicitudReclasificacionService.consultarSolicitud(solicitudReclasificacionConsultarBeanRequest);
	...
	public Boolean actualizarEstatusSolicitud(
		...
		try {
			SolicitudReclasificacionApoVolVO solicitudReclasificacionVO = new SolicitudReclasificacionApoVolVO();

package mx.profuturo.nci.ws.service.impl.apovol.reporte;
...
import mx.profuturo.nci.business.events.report.ElementoReporteGeneralSBC;
...
import mx.profuturo.nci.ws.beans.ReportBean;
...
import mx.profuturo.nci.ws.service.apovol.reporte.IReporteriaSoapAVService;
import mx.profuturo.nci.ws.service.cifctrlreclasificacion.ICifCtrlReclasificacionSoapService;
import mx.profuturo.nci.ws.service.cifrasgenerales.ICifrasGeneralesSoapService;
...
//			     fos.close();
	...
	public CifrasGeneralesReportResponse cifrasControlReclaApoVol(CifrasControlReclaApoVolReportRequest request) {
		...
		try {
			...
			CifrasControlReclaApoVolReportRequestReadEvent requestEvent = new CifrasControlReclaApoVolReportRequestReadEvent();
			...
			final ReporteVO eventResponse = this.cifrasControlReportService.generarArchivoCifrasCtrlReclasificacionApoVol(requestEvent);

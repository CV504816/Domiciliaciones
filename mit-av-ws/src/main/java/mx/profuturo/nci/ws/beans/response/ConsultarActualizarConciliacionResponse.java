...
public class ConsultarActualizarConciliacionResponse {
	
	private String codRet;
	private String msgRet;
	private String descRet;
	
	public ConsultarActualizarConciliacionResponse() {

	}

	public ConsultarActualizarConciliacionResponse(String codRet, String msgRet, String descRet) {
		super();
		this.codRet = codRet;
		this.msgRet = msgRet;

...
public class ArchivoBean extends AbstractAuditoriaBean 
{
	...
	private Date fechaRecepcionProfuturo;
	...
	public Date getFechaRecepcionProfuturo() {
		return fechaRecepcionProfuturo;
	}
	public void setFechaRecepcionProfuturo(Date fechaRecepcionProfuturo) {
		this.fechaRecepcionProfuturo = fechaRecepcionProfuturo;
	}

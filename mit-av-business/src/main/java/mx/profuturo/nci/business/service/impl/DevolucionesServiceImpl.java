...
import mx.profuturo.nci.alux.persistence.ProfuturoALUXPersistence;
...
import mx.profuturo.nci.persistence.ProfuturoNCIPersistence;
...
public class DevolucionesServiceImpl implements IDevolucionesService {
	...
	//@Autowired
//	ProfuturoALUXPersistence aluxPeristence;
	
	@Autowired
	ProfuturoNCIPersistence  nciPeristence;
	
	@Autowired
	ProfuturoCIFPersistence  cifPeristence;
